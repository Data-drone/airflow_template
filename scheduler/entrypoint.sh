...
wait_for_port "Postgres" "$AF_POSTGRES_HOST" "$AF_POSTGRES_PORT"
...
AIRFLOW__CORE__SQL_ALCHEMY_CONN="postgres+psycopg2://$AF_POSTGRES_USER:$AF_POSTGRES_PASSWORD@$AF_POSTGRES_HOST:$AF_POSTGRES_PORT/$AF_POSTGRES_DB"
AIRFLOW__CELERY__RESULT_BACKEND="db+postgresql://$AF_POSTGRES_USER:$AF_POSTGRES_PASSWORD@$AF_POSTGRES_HOST:$AF_POSTGRES_PORT/$AF_POSTGRES_DB"
