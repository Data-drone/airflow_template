...
echo "Postgres is on ${POSTGRES_HOST} and Redis is on ${REDIS_HOST}"

wait_for_port "AF Postgres" "$POSTGRES_HOST" "$POSTGRES_PORT"
...
AIRFLOW__CORE__SQL_ALCHEMY_CONN="postgres+psycopg2://$POSTGRES_USER:$POSTGRES_PASSWORD@$POSTGRES_HOST:5432/$POSTGRES_DB"
